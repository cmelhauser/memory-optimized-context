...
Checks, each re-derived from the repository rather than trusted:
  ...
  4. No tracked file contains a host-specific home path (`/Users/<name>`), except the
     placeholder `/Users/<you>`. The Compose file uses ${HOME}; the hooks use $HOME.
...
PROSE = ["README.md", "AGENTS.md", "CLAUDE.md", "HANDOFF.md", "CHANGELOG.md", "CONTRIBUTING.md", "RELEASING.md"]
...
def main():
    ...
    home = re.compile(r"/Users/(?!<you>)[A-Za-z0-9_.-]+")
    for p in tracked_files():
