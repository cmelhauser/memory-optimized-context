...
`v0.1.0`. 82 tests, coverage 100 per cent of lines and branches on `bin/memory` and the tools CI
...
tests/test_memory.py       82 tests, six-process concurrency test included
